<div id="slider">
   <div id="slider-inner">
      <div id="slider-main">
         <r:img uri="${featuredDeal.largeImage}" />
         <div id="slider-desc">
      ...
      <div id="slider-info">
         ...
         <p class="small">${featuredDeal.teaser} <a href="#">Read More</a>
         </p>
         <span class="nowonly">Now Only</span>
         <div id="deal-price">
            <span class="prev-price">
               <g:formatNumber number="${featuredDeal.originalPrice}" format="\$###,##0" />
            </span>
            <span class="actual-price">
               <g:formatNumber number="${featuredDeal.price}" format="\$###,##0" />
            </span>
         </div>
      ...
      <div id="slider-reel">
         <g:each var="otherDeal" in="${otherDeals}">
            <div id="slider-image${sliderIndex++}" class="reel-img">
               <a href="#">
                  <r:img uri="${otherDeal.smallImage}" border="0" />
               </a>
            </div>
         </g:each>
      </div>
