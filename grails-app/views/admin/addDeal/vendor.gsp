         ...
         <div class="row second-row">
            ...
            <div class="span9">
               <g:form class="form-horizontal">
                  <fieldset>
                     <legend>Add a Deal - Vendor</legend>
                     <p>Select a Vendor already in the system...</p>
                     <div class="control-group">
                        <label class="control-label" for="input01">Vendors</label>
                        <div class="controls">
                     ...
                     <hr />
                     <p>... or define a new one for this deal.</p>
                     <div class="control-group">
                     ...
                     <div class="form-actions">
                        ...
                        <a id="continueBtn" href="continue" class="btn btn-primary">Review</a>
