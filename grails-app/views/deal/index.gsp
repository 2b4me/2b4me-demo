            ...
            <div id="content-main">
               ...
               <div id="deal-info">
                  ...
                  <div id="deal-price">
                     ...
                     <a href="#" class="green-btn lvl2 nyi" id="buynow-deal">buy now</a>
                  </div>
                  <div id="deal-off">
            ...
            <div id="related">
               ...
               <g:each var="relatedDeal" in="${relatedDeals}" status="i">
                  <div class="relblocks" id="relblock${i+1}">
                     ...
                     <h4 class="dealnames"><g:link controller="deal" id="${relatedDeal.shortName}">${relatedDeal.title}</g:link></h4>
                     ...
                     <div class="deals-price">
                        ...
                        <g:link controller="deal" id="${relatedDeal.shortName}" class="green-btn buynow">Buy now</g:link>
                     </div>
                  </div>
               </g:each>
            </div>
