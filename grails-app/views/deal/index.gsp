	...
	<!-- InstanceBeginEditable name="container-inner" -->
		...
		<div id="container-inner"><!--do not remove this div-->
			...
			<div id="content-main">
				...
				<div id="deal-info">
					<h1>Hotels Discounts</h1>
					<p id="deal-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut a risus elit, ut sodales elit. Duis sollicitudin molestie velit. Suspendisse id diam et diam varius sagittis id quis mi.</p>
					
					<div id="deal-price">
						<span class="actual-price">$399</span>
						<a href="#" class="green-btn lvl2" id="buynow-deal">buy now</a>
					</div>
					<div id="deal-off">
						<span id="off">50%</span><small>off</small>
						<span id="remain">5 days remaining</span>
						<a href="#" id="get-yours">Get yours free</a>
					</div>
